    ...
    function guessHangmanLetter(l) {
      ...
      if(normalizarP(hangWordObj.real).includes(lN)) {
        ...
        if(!nO.includes('_')) { historialRespuestas.push({pre: "Palabra Oculta", res: "Descubierta", cor: hangWordObj.real, exp: hangWordObj.pista}); puntajeJuego+=3; updatePuntajeGlobal(2); ronda++; setTimeout(startHangmanWord, 1000); }
      } else {
